...
public class Type1 {
	 ...
	 *
	 * @param libelle1 le nom du type 1 à créer
	 ...
	 *
	 * @param idType1 l'identifiant d'un objet type1 déjà enregistré en base de donnée
	 */
	...
	/**
	 * Constructeur utilisé pour la création de la liste de tous les objets de types 1 enregistrés en base de donnée
	 *
	 * @param idType1 l'identifiant d'un objet type1 déjà enregistré en base de donnée
	 * @param libelle1 le nom du type 1 à créer
	 */
	...
	//Envoie de l'enregistrement de l'objet type 1 vers la couche d'accès à la base de donnée
	/**
	 * Méthode sauvegardant un objet Type1 à partir de son libellé pour préparer son enregistrement.
	 *
	 * 
	 * @throws SQLException the SQL exception
	 */
	...
	/**
	 * Methode getteur retournant la liste de tous les types 1 stockés en base de donnée
	 *
