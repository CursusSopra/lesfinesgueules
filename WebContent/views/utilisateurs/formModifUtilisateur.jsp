...
<div class="row" id="divFormModifProfil">

	<form class="form-horizontal" id="modifProfilForm" method="post"
		action="<s:url action='update'/>">
		<input type="hidden" id="idUtilisateur"
			name="idUtilisateur" value="<s:property value="idUtilisateur"/>">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control input-lg" id="idNom"
						name="nom" value="<s:property value="nom"/>" placeholder="Nom">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control input-lg"
						id="idLigneAdresse1" name="ligneAdresse1"
						value="<s:property value="ligneAdresse1"/>" placeholder="Rue">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="idTel" class="col-sm-2 control-label">Numéro de
					téléphone</label>
				<div class="col-sm-6">
					<input type="text" class="form-control input-lg" id="idTel"
						name="tel" value="<s:property value="tel"/>"
